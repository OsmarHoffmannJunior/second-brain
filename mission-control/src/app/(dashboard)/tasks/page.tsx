    ...
    <div className="p-6 space-y-4">
      ...
      {loading ? (
        ...
        <KanbanBoard
          initialTasks={tasks}
          onTasksUpdate={() => {
            // Refetch without loading spinner — just update parent state
            fetch('/api/tasks')
              .then((r) => r.json())
      ...
      {/* key forces remount so form state resets every time modal opens */}
      <TaskModal
        key={showNewModal ? 'new-open' : 'new-closed'}
        task={null}
        isOpen={showNewModal}
