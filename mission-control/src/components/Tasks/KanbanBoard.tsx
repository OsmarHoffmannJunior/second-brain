...
interface KanbanBoardProps {
  initialTasks: Task[];
  /** Called after a save so parent can refetch/re-sync */
  onTasksUpdate?: () => void;
}

const COLUMNS: TaskStatus[] = ['backlog', 'in_progress', 'review', 'done'];

export default function KanbanBoard({ initialTasks, onTasksUpdate }: KanbanBoardProps) {
  const [tasks, setTasks] = useState<Task[]>(initialTasks);

  // Sync with parent when parent refetches (source of truth after save)
  useEffect(() => {
