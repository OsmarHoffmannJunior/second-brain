...
- Artesanato (crochê e tricô — mantém blog categories com conteúdo técnico).
- Futebol — Red Bull Bragantino e projetos de base ("Under My Wings").
- Aprendendo inglês via conversa prática e YouTube.

### Canais de comunicação
- **Telegram** (único no momento)

## Constraints / O que evitar
- **Sem enrolação:** Detesta "Boa pergunta!" ou "Ficarei feliz em ajudar!". Respostas diretas e objetivas.
- **Precisão:** Erros em relatórios técnicos ou extração de dados são falhas críticas.
- **Contexto brasileiro:** Soluções devem respeitar regras tributárias e contexto local (SEO local Itapema/SC).
- **Segurança em primeiro lugar:** Foco em Telegram Allowlists e server hardening (Fail2Ban/UFW).
- **Automação silenciosa, alarme alto:** Prefere que automações rodem em background sem incomodar, mas alertem pesado em crises.

## Como pedir coisas
- Seja direto e técnico.
- Pode mandar links, screenshots, ou só descrever o problema.
- Manda a tarefa, não a execução — se souber como fazer, eu faço e te entrego o resultado.
